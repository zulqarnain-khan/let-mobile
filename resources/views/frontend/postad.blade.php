        ...
        <div class="row">
            <div class="col-md-12">
                <div class="breadcrumb-wrapper">
                    <h1 class="product-title">Post a free Classified Ad</h1>
                    <ol class="breadcrumb">
                                  ...
                                  <fieldset>
                                      ...
                                      <div class="form-group mb-3">
                                          <div class="form-group">
                                              ...
                                              <div class="select2">
                                                  <input class="form-control select2-input bg-white text-capitalize" type="text" placeholder="Select Brand" readonly="readonly" id="select2-input">
                                                  <input class="d-none select2-value invisible" id="item" name="brand" type="hidden" readonly="readonly">
                                      ...
                                      <div class="form-group mb-3">
                                          ...
                                          <div class="">
                                              <input type="text" name="phone" id="phone" placeholder="923xxxxxxxxx"  class="form-control input-md" title="Use phone number as 03xxxxxxxxx" value="{{ Session::get('phone') }}">
                                          </div>
                                      </div>
                                  </fieldset>
                            </div>
                        ...
                        <div class="tg-contactdetail">
                            ...
                            <div class="dashboard-wrapper text-center">
                                ...
                                <label class="tg-fileuploadlabel" for="tg-photogallery1">
                                    ...
                                    <input id="tg-photogallery1" class="tg-fileinput1" accept='image/*' type="file" name="image[]">
                                </label>
                                <label class="tg-fileuploadlabel" for="tg-photogallery2">
                                    <div id="divImageMediaPreview2"></div>
                                    <span class="btn btn-common">Select File</span>
                                    <input id="tg-photogallery2" class="tg-fileinput2" accept='image/*' type="file" name="image[]">
                                </label>
                                <label class="tg-fileuploadlabel" for="tg-photogallery3">
                                    <div id="divImageMediaPreview3"></div>
                                    <span class="btn btn-common">Select File</span>
                                    <input id="tg-photogallery3" class="tg-fileinput3" accept='image/*' type="file" name="image[]">
                                </label>
                                <label class="tg-fileuploadlabel" for="tg-photogallery4">
                                    <div id="divImageMediaPreview4"></div>
                                    <span class="btn btn-common">Select File</span>
                                    <input id="tg-photogallery4" class="tg-fileinput4" accept='image/*' type="file" name="image[]">
                                </label>
                            </div>
                        </div>
                    </div>
                     ...
                     <div class="inner-box" >
                        <div class="tg-contactdetail">
                            ...
                            <div class="dashboard-wrapper">
                              <div class="form-group mb-3">
                                <div class="form-group">
                                    ...
                                    <div class="select2">
                                        <input class="form-control select2-input_loc bg-white text-capitalize" type="text" placeholder="Select Location" readonly="readonly" id="select2-input_loc">
                                        <input class="d-none select2-value_loc invisible" id="item" name="location" type="hidden" readonly="readonly">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <div class="">
                                    <input type="text" name="adadress" value="" id="adadress" placeholder="Street Address"  class="form-control input-md" title="Street Address">
                                </div>
                            </div>
