...
@section('title')
<title><?php echo @ucwords($blog->blog_title); ?> | Let Mobile  </title>
<meta name="description" content="<?php echo $blog->short_description; ?>">
@stop
@section('page-css')
<link rel="stylesheet" href="//code.jquery.com/ui/1.12.1/themes/base/jquery-ui.css">
<meta property="og:url" content="<?php echo url('blogs/'.$blog->blog_slug); ?>" />
<meta property="og:type" content="website" />
<meta property="og:title" content="{{ ucwords($blog->blog_title) }}" />
<meta property="og:image" content="<?php echo url('public/blogimages/'.$blog->blog_image); ?>" />
<meta property="og:image:alt" content="{{ ucwords($blog->blog_title) }}" />
@stop
@section('content')
<div class="hidden-sharer">
    <img src="<?php echo url('public/blogimages/'.$blog->blog_image); ?>" alt="{{ ucwords($blog->blog_title) }}" />
</div>
<div class="page-header" style="background: url(<?php echo url('public/blogimages/'.$blog->blog_image); ?>);    background-position: bottom;">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="breadcrumb-wrapper">
                    <h1 class="product-title"><?=stripslashes($blog->blog_title)?></h1>
                    <ol class="breadcrumb">
            ...
            <div class="col-lg-8 col-md-12 col-xs-12">
                <div class="blog-post single-post">
                    <div class="post-thumb">
                        <a href="<?php echo url('blogs/'.$blog->blog_slug); ?>"><img class="img-fluid img-width-100" src="<?php echo url('public/blogimages/'.$blog->blog_image); ?>" alt="<?php echo @ucwords($blog->blog_title); ?>"></a>
                        ...
                        <div class="float-right">
                            <div class="share">
                                <div class="social-link">
                                    <a target="_blank" class="facebook" data-toggle="tooltip" data-placement="top" title="facebook" href="https://www.facebook.com/sharer/sharer.php?u={{ url('blogs/') }}/{{ $blog->blog_slug }}"><i class="lni-facebook-filled"></i></a>
                                    <a target="_blank" class="twitter" data-toggle="tooltip" data-placement="top" title="twitter" href="https://twitter.com/intent/tweet?status={{ ucwords($blog->blog_title) }} here is Link for {{ url('blogs/') }}/{{ $blog->blog_slug }}"><i class="lni-twitter-filled"></i></a>
                                    <a target="_blank" class="linkedin" data-toggle="tooltip" data-placement="top" title="linkedin" href="https://www.linkedin.com/shareArticle?url={{ url('blogs/') }}/{{ $blog->blog_slug }}&title={{ ucwords($blog->blog_title) }}&source=Let Mobile"><i class="lni-linkedin-fill"></i></a>
                                    <a target="_blank" class="google" href="whatsapp://send?text=Check this out:{{ ucwords($blog->blog_title) }} here is link for {{ url('blogs/') }}/{{ $blog->blog_slug }}" data-action="share/whatsapp/share"><i class="fa fa-whatsapp"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <li>
                            <div class="widget-thumb">
                                <a href="<?php echo url('blogs/'.$blog->blog_slug); ?>">
                                    <img onerror="this.src='<?php echo url('images/noimage.png'); ?>'" src="<?php echo url('public/blogimages/'.$blog->blog_image); ?>" alt="<?php echo @ucwords($blog->blog_title); ?>" />
                                </a>
                            </div>
                            <div class="widget-content">
                                <a href="<?php echo url('blogs/'.$blog->blog_slug); ?>"><?php echo @ucwords(substr($blog->blog_title,0,20)); ?></a>
                                <span><i class="icon-calendar"></i><?=date_format(date_create($blog->created_at), 'jS F Y')?></span>
                            </div>
